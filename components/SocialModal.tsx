...
const SOCIAL_ACCOUNTS = [
  {
    platform: 'Instagram',
    handle: '@jonahandthewhale17',
    desc: 'Daily insights on education, wealth & legacy.',
    url: 'https://www.instagram.com/jonahandthewhale17?igsh=MTI5ZmI3MGl0enV5Yg==',
    accent: '#E1306C',
  ...
  },
  {
    ...
    url: 'https://www.facebook.com/share/1FsLkECQmz/?mibextid=wwXIfr',
    accent: '#1877F2',
  ...
  },
  {
    ...
    url: 'https://www.linkedin.com/in/jonah-stevens-74019920?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app',
    accent: '#0A66C2',
  ...
  {
    platform: 'Website',
    handle: 'jonahstevens.com',
    desc: 'Interactive resume — the full story behind the ecosystem.',
    url: 'https://jonahstevens.com/',
    accent: '#a78bfa',
